      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              style={{
                ...
                background: "#fff",
                boxShadow: "0 4px 16px rgba(76, 126, 251, 0.15)",
          ...
          <div
            style={{
              ...
              height: "140px",
              background:
                "linear-gradient(180deg, #4C7EFB 0%, rgba(76, 126, 251, 0.3) 100%)",
              borderRadius: "2px",
              boxShadow: "0 2px 8px rgba(76, 126, 251, 0.2)",
            }}
          />
              ...
              <div
                ...
                style={{
                  ...
                  border: selectedDeliveryMethods.includes("mobile")
                    ? "3px solid #4C7EFB"
                    : "2px solid #e0e7ff",
                  background: selectedDeliveryMethods.includes("mobile")
                    ? "linear-gradient(135deg, rgba(76, 126, 251, 0.15) 0%, rgba(76, 126, 251, 0.05) 100%)"
                    : "#fff",
                  cursor: "pointer",
                  transition: "all 0.3s ease",
                  boxShadow: selectedDeliveryMethods.includes("mobile")
                    ? "0 8px 24px rgba(76, 126, 251, 0.25)"
                    : "0 4px 12px rgba(0, 0, 0, 0.08)",
                  transform: selectedDeliveryMethods.includes("mobile")
                    ? "translateY(-2px)"
                    : "translateY(0)",
                }}
              >
                ...
                >
                  <span
                    style={{
                      color: selectedDeliveryMethods.includes("mobile")
                        ? "#4C7EFB"
                        : "#6b7280",
                      fontSize: "16px",
                      fontFamily:
              ...
              <div
                ...
                style={{
                  ...
                  border: selectedDeliveryMethods.includes("email")
                    ? "3px solid #4C7EFB"
                    : "2px solid #e0e7ff",
                  background: selectedDeliveryMethods.includes("email")
                    ? "linear-gradient(135deg, rgba(76, 126, 251, 0.15) 0%, rgba(76, 126, 251, 0.05) 100%)"
                    : "#fff",
                  cursor: "pointer",
                  transition: "all 0.3s ease",
                  boxShadow: selectedDeliveryMethods.includes("email")
                    ? "0 8px 24px rgba(76, 126, 251, 0.25)"
                    : "0 4px 12px rgba(0, 0, 0, 0.08)",
                  transform: selectedDeliveryMethods.includes("email")
                    ? "translateY(-2px)"
                    : "translateY(0)",
                }}
              >
                ...
                >
                  <span
                    style={{
                      color: selectedDeliveryMethods.includes("email")
                        ? "#4C7EFB"
                        : "#6b7280",
                      fontSize: "16px",
                      fontFamily:
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  border: "3px dashed #4C7EFB",
                  cursor: "pointer",
                  transition: "all 0.3s ease",
                  boxShadow: "0 4px 16px rgba(76, 126, 251, 0.1)",
                }}
              >
                <div
                  style={{
        ...
        <div
          style={{
            ...
            height: "2px",
            background:
              "linear-gradient(90deg, transparent 0%, #4C7EFB 50%, transparent 100%)",
            borderRadius: "1px",
            maxWidth: "800px",
          }}
        />

        {/* Section 2: When to Send and Date/Time Selection - Exact Figma Design */}
        <div
          style={{
            display: "flex",
            justifyContent: "flex-end",
        ...
        >
          {/* Time Selection - Rightmost - Only show if "later" is selected */}
          {sendingMethod === "later" && (
            <div
              style={{
                display: "flex",
          ...
          {/* Vertical Divider 1 - Only show if "later" is selected */}
          {sendingMethod === "later" && (
            <svg
              style={{
                width: "0",
            ...
            >
              <path
                opacity="0.2"
                d="M0.867188 0.0683594V113.068"
                stroke="#486284"
              />
            </svg>
          )}

          {/* Date Selection - Center - Only show if "later" is selected */}
          {sendingMethod === "later" && (
            <div
              style={{
                display: "flex",
          ...
          {/* Vertical Divider 2 - Only show if "later" is selected */}
          {sendingMethod === "later" && (
            <svg
              style={{
                width: "0",
          ...
          {/* When to Send - Leftmost */}
          <div
            style={{
              display: "flex",
              width: sendingMethod === "later" ? "400px" : "100%",
              flexDirection: "column",
              alignItems: "center",
              justifyContent: "center",
              gap: "30px",
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{
                      color:
                        sendingMethod === "immediately" ? "#4C7EFB" : "#1B1919",
                      textAlign: "right",
                      fontFamily:
                        "Poppins, -apple-system, Roboto, Helvetica, sans-serif",
                      fontSize: "18px",
                ...
                >
                  ...
                  <div
                    style={{
                      color: sendingMethod === "later" ? "#4C7EFB" : "#1B1919",
                      textAlign: "right",
                      fontFamily:
                        "Poppins, -apple-system, Roboto, Helvetica, sans-serif",
                      fontSize: "18px",
        ...
        >
          {recipients.map((recipient, index) => {
            const showPhoneError =
              recipient.phone.length > 0 && !isValidPhone(recipient.phone);
            return (
              <div
                key={recipient.id}
                style={{
              ...
              >
                {/* Recipient Header - Only show when there are multiple recipients */}
                {recipients.length > 1 && (
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = "#E96036";
                        e.currentTarget.style.color = "#FFF";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = "#FFE1D8";
                        e.currentTarget.style.color = "#E96036";
                      }}
                    >
                      ×
                    </button>
