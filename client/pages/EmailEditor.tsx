...
export default function EmailEditor() {
  return (
    <div className="relative w-full bg-white hebrew-font" dir="rtl" style={{ width: '1920px', height: '1919px' }}>
      ...
      <footer className="relative w-full bg-[#DBE3F3] overflow-hidden" style={{ height: '308px', position: 'absolute', left: '0px', top: '1611px', width: '1920px' }}>
        <div className="relative w-full h-full">
          {/* Main Footer Content */}
          <div className="absolute inline-flex items-center gap-[3px]" style={{ left: '550px', top: '76px', width: '1228px', height: '152px' }}>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex flex-col items-end gap-5" style={{ width: '281px' }}>
                ...
                <div className="flex flex-col justify-between items-end gap-0" style={{ height: '105px' }}>
                  {/* TikTok */}
              ...
              {/* Vertical Divider 1 */}
              <svg style={{ width: '0', height: '151.859px', strokeWidth: '1px', stroke: '#4C7EFB' }} width="2" height="153" viewBox="0 0 2 153" fill="none">
              ...
              {/* Vertical Divider 3 */}
              <svg style={{ width: '0', height: '151.859px', strokeWidth: '1px', stroke: '#4C7EFB' }} width="1" height="153" viewBox="0 0 1 153" fill="none">
          ...
          <div className="absolute" style={{ width: '207px', height: '338px', left: '78px', top: '-92px' }}>
            {/* Stock4U Text */}
            <div className="absolute" style={{ left: '0px', top: '282px', width: '207px', height: '56px' }}>
            ...
            {/* Mascot */}
            <div className="absolute" style={{ left: '24px', top: '0px', width: '160px', height: '253px' }}>
              {/* White background shape */}
              <svg className="absolute" style={{ left: '2px', top: '29px', width: '139px', height: '152px' }} viewBox="0 0 140 153" fill="none">
              ...
              <div className="absolute left-0 top-0" style={{ width: '160px', height: '253px', filter: 'drop-shadow(3.658px 3.658px 0 rgba(0, 0, 0, 0.10))' }}>
                <div style={{ width: '160px', height: '253px', filter: 'drop-shadow(7.945px 6.179px 0 rgba(0, 0, 0, 0.15))' }}>
                  <img 
                    ...
                    className="absolute" 
                    style={{ left: '2px', top: '129px', width: '158px', height: '123px', strokeWidth: '7.263px', stroke: '#FFF' }}
                    alt="Vector" 
                  />
                  <img 
                    src="https://api.builder.io/api/v1/image/assets/TEMP/59db7a18eb7b39c2e75ee6fd94da12eaa837cd53?width=255" 
                    className="absolute" 
                    style={{ left: '8px', top: '0px', width: '127px', height: '178px', strokeWidth: '18.289px', stroke: '#FFF' }}
                    alt="Union" 
                  />
                  <div className="absolute bg-white" style={{ left: '62px', top: '173px', width: '24px', height: '10px' }}></div>
                  <div className="absolute bg-white" style={{ left: '113px', top: '77px', width: '24px', height: '22px' }}></div>
                  <div className="absolute bg-white" style={{ left: '0px', top: '73px', width: '24px', height: '18px' }}></div>
                  <img 
                    src="https://api.builder.io/api/v1/image/assets/TEMP/685d5572691242b8942ab0b9027b073df03ded46?width=315" 
                    className="absolute" 
                    style={{ left: '2px', top: '129px', width: '158px', height: '123px' }}
                    alt="Group 108277" 
                  />
                </div>
                <img 
                  ...
                  className="absolute" 
                  style={{ left: '9px', top: '0px', width: '124px', height: '173px' }}
                  alt="Group 108355" 
                />
              </div>
            </div>
