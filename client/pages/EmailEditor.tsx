export default function EmailEditor() {
  return (
    <div className="relative w-full bg-white hebrew-font" dir="rtl">
      ...
      {/* Footer */}
      <footer className="bg-stock4u-light-blue py-16">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Social Media */}
            <div className="text-right">
              <h3 className="text-stock4u-happy-blue text-2xl font-bold mb-6">אנחנו ברשתות</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">טיקטוק</span>
                ...
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">אינסטגרם</span>
                ...
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">פייסבוק</span>
            ...
            {/* Contact */}
            <div className="text-right">
              <h3 className="text-stock4u-happy-blue text-2xl font-bold mb-6">צרו קשר</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">support@stock4u.co.il</span>
                ...
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">03-12345678</span>
                ...
                <div className="flex items-center justify-end gap-3">
                  <span className="text-stock4u-happy-blue text-lg">כניסת בתי עסק - שותפים</span>
            ...
            {/* Legal */}
            <div className="text-right">
              <h3 className="text-stock4u-happy-blue text-2xl font-bold mb-6">מידע משפטי</h3>
              <div className="space-y-4">
                <div className="text-stock4u-happy-blue text-lg">תנאי שימוש</div>
                <div className="text-stock4u-happy-blue text-lg">מדיניות פרטיות</div>
                <div className="text-stock4u-happy-blue text-lg">מדיניות החזרים</div>
              </div>
            </div>

            {/* Additional Pages */}
            <div className="text-right">
              <h3 className="text-stock4u-happy-blue text-2xl font-bold mb-6">עמודים נוספים</h3>
              <div className="space-y-4">
                <div className="text-stock4u-happy-blue text-lg">אודות</div>
                <div className="text-stock4u-happy-blue text-lg">קריירה</div>
                <div className="text-stock4u-happy-blue text-lg">שאלות תשובות</div>
              </div>
            </div>
          </div>
