...
<body>
  ...
  const loadTemplate = () => {
    ...
    if (savedTemplate) {
      ...
      setSenderName(templateData.senderName || 'United');
      setRecipientName(templateData.recipientName || '');
      setGiftAmount(templateData.giftAmount || '');
      setShowLogo(templateData.showLogo !== undefined ? templateData.showLogo : true);
      alert('התבנית נטענה בהצלחה!');
    } else {
      alert('לא נמצאה תבנית שמורה');
    }
  };
