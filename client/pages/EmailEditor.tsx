  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden hebrew-font" dir="rtl">
      ...
      <div className="relative w-full h-[785px] bg-[#FFC547] overflow-hidden">
        ...
        <svg className="absolute left-[100px] top-[615px] w-[46px] h-[56px] drop-shadow-[10px_10px_0_rgba(0,0,0,0.10)]" viewBox="0 0 111 127" fill="none">
        ...
        <svg className="absolute left-[1492px] top-[603px] w-[110px] h-[135px] drop-shadow-[10px_10px_0_rgba(0,0,0,0.10)]" viewBox="0 0 175 206" fill="none">
        ...
        <svg className="absolute left-[1645px] top-[528px] w-[64px] h-[66px] drop-shadow-[12.988px_12.988px_0_rgba(0,0,0,0.10)]" viewBox="0 0 101 104" fill="none">
        ...
        <svg className="absolute left-[272px] top-[347px] w-[140px] h-[146px] drop-shadow-[12.988px_12.988px_0_rgba(0,0,0,0.10)]" viewBox="0 0 177 183" fill="none">
        ...
        {/* Special Rotated Gift Shape */}
        <svg className="absolute left-[643px] top-[95px] w-[103px] h-[125px] transform rotate-[-8.311deg]" viewBox="0 0 121 140" fill="none">
        ...
        <img 
          ...
          alt="3D Currency" 
          className="absolute left-[1357px] top-[283px] w-[168px] h-[166px] transform rotate-[21.656deg]"
        />
        <img 
          src="https://api.builder.io/api/v1/image/assets/TEMP/650efdca367c7620a9484f97f351d434be96470b?width=340" 
          alt="3D Currency" 
          className="absolute left-[512px] top-[395px] w-[170px] h-[169px] transform rotate-[-176.855deg]"
        />
        <img 
          src="https://api.builder.io/api/v1/image/assets/TEMP/637edfefd1c11e22f05f22ca05071c44e431aa66?width=341" 
          alt="3D Currency" 
          className="absolute left-[368px] top-[90px] w-[171px] h-[169px]"
        />

        {/* Stock4U Mascot - מיקום מדויק */}
        <div className="absolute left-[846px] top-[106px] w-[220px] h-[348px]">
          <svg className="absolute left-[3px] top-[39px] w-[191px] h-[209px]" viewBox="0 0 192 210" fill="none">
          ...
          <div className="w-[220px] h-[348px] drop-shadow-[5.036px_5.036px_0_rgba(0,0,0,0.10)] absolute left-0 top-0">
            <div className="w-[220px] h-[348px] drop-shadow-[10.939px_8.508px_0_rgba(0,0,0,0.15)] absolute left-0 top-0">
              <img 
                src="https://api.builder.io/api/v1/image/assets/TEMP/1e0545a47a34fcc8241c785c8ca54af1ef8130e1?width=434" 
                alt="" 
                className="w-[217px] h-[170px] absolute left-[3px] top-[178px]"
              />
              <img 
                src="https://api.builder.io/api/v1/image/assets/TEMP/e303d7b87531d68f67aaa5e745cd58d670c05c69?width=351" 
                alt="" 
                className="w-[175px] h-[246px] absolute left-[11px] top-0"
              />
              <div className="w-[34px] h-[13px] bg-white absolute left-[85px] top-[238px]"></div>
              <div className="w-[34px] h-[31px] bg-white absolute left-[155px] top-[106px]"></div>
              <div className="w-[34px] h-[25px] bg-white absolute left-0 top-[101px]"></div>
              <img 
            ...
            <img 
              ...
              alt="Stock4U Mascot" 
              className="w-[170px] h-[238px] absolute left-[12px] top-0"
            />
          </div>
        </div>

        {/* Main Content Card - מיקום ועיצוב מדויק לפי הפיגמה */}
        <div className="flex w-[1184px] h-[599px] px-[21px] py-[19px] justify-center items-center rounded-[34.431px] bg-white shadow-[0_4px_39.1px_0_rgba(0,0,0,0.25)] absolute left-[368px] top-[428px]">
          <div className="flex w-[1084px] flex-col items-center gap-10">
            {/* Heading Section */}
            <div className="flex w-[762.805px] flex-col items-center gap-[13.313px]">
              <div className="w-[468.08px] text-[#E96036] text-center text-[34px] font-bold leading-normal">
                איזה כיף!
              </div>
              <div className="w-[468.08px] text-[#E96036] text-center text-[64px] font-bold leading-normal">
                קיבלת מתנה!
              </div>
            </div>
            
            {/* Sender Text */}
            <div className="w-[338.879px] text-[#4C7EFB] text-center text-2xl font-normal leading-normal">
              ממי המתנה? United כמובן!
            </div>
            
            {/* Logo */}
            <img 
              className="w-[552.254px] h-[105.149px] rounded-[15.421px]" 
              src="https://api.builder.io/api/v1/image/assets/TEMP/378ddfe0d1afad1c8baf4e915e3a1587e200b3b8?width=1105" 
              alt="United Logo" 
            />
            
            {/* Button */}
            <div className="w-[270px] h-[70px] relative">
              <div className="flex w-[270px] px-[10px] flex-col items-start gap-[10px] h-[70px] absolute left-0 top-0">
                <div className="flex h-[50px] px-[14px] py-[14px] justify-center items-center gap-[10px] self-stretch rounded-[56px] bg-[#4C7EFB] shadow-[10px_10px_0_0_rgba(0,0,0,0.10)]">
                  <div className="w-[115px] h-[14.383px] text-white text-center text-lg font-bold leading-normal">
                    לצפייה במתנה
                  </div>
                </div>
              </div>
      ...
      {/* Stats Section - מיקום ועיצוב מדויק */}
      <div className="flex w-[1216px] items-start gap-6 absolute left-[352px] top-[1158px] h-[188px]">
        <div className="flex px-8 py-8 flex-col items-center gap-4 flex-1 rounded-3xl bg-[rgba(239,242,246,0.40)]">
          <div className="self-stretch text-[#486284] text-center text-[60px] font-bold leading-[76px] tracking-[0.5px]">
            24+
          </div>
          <div className="self-stretch text-[#8CA2C0] text-center text-xl font-normal leading-8 tracking-[0.5px]">
      ...
      {/* Footer Section - עיצוב מדויק לפי הפיגמה */}
      <div className="w-full h-[308px] bg-[#DBE3F3] absolute left-0 top-[1411px]">
        <div className="inline-flex items-center gap-[3px] absolute left-[550px] top-[76px] w-[1228px] h-[152px]">
          {/* Social Media Column */}
          <div className="flex items-center gap-6">
            <div className="flex w-[281px] flex-col items-end gap-5">
              <div className="self-stretch text-stock4u-happy-blue text-right text-2xl font-bold leading-normal">
                אנחנו ברשתות
              </div>
              <div className="flex h-[105px] flex-col justify-between items-end self-stretch">
                <div className="flex justify-end items-center self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">טיקטוק</div>
                  <svg className="flex px-2 items-center gap-[10px]" width="32" height="35" viewBox="0 0 32 35" fill="none">
                ...
                <div className="flex justify-end items-center self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">אינסטגרם</div>
                  <svg className="flex px-2 py-2 flex-col items-start gap-[10px]" width="33" height="34" viewBox="0 0 33 34" fill="none">
                ...
                <div className="flex justify-end items-center self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">פייסבוק</div>
                  <div className="flex px-2 py-2 flex-col items-start gap-[10px]">
            ...
            <svg className="w-0 h-[151.859px] stroke-stock4u-happy-blue stroke-1" viewBox="0 0 2 153" fill="none">
              <path d="M0.988281 0.65332V152.513" stroke="#4C7EFB"/>
            </svg>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="flex w-[281px] flex-col items-end gap-5">
              ...
              <div className="flex h-[105px] flex-col justify-between items-end self-stretch">
                <div className="flex justify-end items-center self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">support@stock4u.co.il</div>
                  <svg className="flex px-2 py-[7px] flex-col items-start gap-[10px]" width="35" height="33" viewBox="0 0 35 33" fill="none">
                ...
                <div className="flex justify-end items-center gap-[3px] self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">03-12345678</div>
                  <svg className="flex px-[10px] py-1 items-center gap-[10px]" width="34" height="31" viewBox="0 0 34 31" fill="none">
                ...
                <div className="flex justify-end items-center self-stretch">
                  <div className="text-stock4u-happy-blue text-right text-lg font-normal">כניסת בתי עסק - שותפים</div>
                  <svg className="flex px-2 items-center gap-[10px]" width="37" height="38" viewBox="0 0 37 38" fill="none">
          ...
          {/* Legal Column */}
          <div className="flex items-center gap-6">
            <div className="flex w-[280.512px] flex-col items-end gap-5">
              <div className="self-stretch text-stock4u-happy-blue text-right text-2xl font-bold leading-normal">
                מידע משפטי
              </div>
              <div className="flex h-[105px] flex-col justify-between items-end self-stretch">
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">תנאי שימוש</div>
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">מדיניות פרטיות</div>
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">מדיניות החזרים</div>
              </div>
            </div>
            <svg className="w-0 h-[151.859px] stroke-stock4u-happy-blue stroke-1" viewBox="0 0 1 153" fill="none">
              <path d="M0.5 0.65332V152.513" stroke="#4C7EFB"/>
            </svg>
          </div>
          ...
          <div className="flex items-center gap-6">
            <div className="flex w-[280.512px] flex-col items-end gap-5">
              ...
              <div className="flex h-[105px] flex-col justify-between items-end self-stretch">
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">אודות</div>
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">קריירה</div>
                <div className="self-stretch text-stock4u-happy-blue text-right text-lg font-normal">שאלות תשובות</div>
              </div>
            </div>
            <svg className="w-0 h-[151.859px] stroke-stock4u-happy-blue stroke-1" viewBox="0 0 2 153" fill="none">
              <path d="M1.01172 0.65332V152.513" stroke="#4C7EFB"/>
            </svg>
          </div>
        </div>

        {/* Footer Logo Section */}
        <div className="w-[207px] h-[338px] absolute left-[78px] top-[-92px]">
          <div className="w-[207px] h-[56px] text-stock4u-happy-blue text-[33px] font-normal leading-normal uppercase absolute left-0 top-[282px]">
            Stock4U
          </div>
          <div className="w-[160px] h-[253px] absolute left-6 top-0">
            <svg className="w-[139px] h-[152px] absolute left-[2px] top-[29px]" viewBox="0 0 140 153" fill="none">
            ...
            <div className="w-[160px] h-[253px] drop-shadow-[3.658px_3.658px_0_rgba(0,0,0,0.10)] absolute left-0 top-0">
              <div className="w-[160px] h-[253px] drop-shadow-[7.945px_6.179px_0_rgba(0,0,0,0.15)] absolute left-0 top-0">
                <img 
                  src="https://api.builder.io/api/v1/image/assets/TEMP/223db13298bda3b663ae4f9e2ea1a5c6f9c437f6?width=315" 
                  alt="" 
                  className="w-[158px] h-[123px] absolute left-[2px] top-[129px]"
                />
                <img 
                  src="https://api.builder.io/api/v1/image/assets/TEMP/59db7a18eb7b39c2e75ee6fd94da12eaa837cd53?width=255" 
                  alt="" 
                  className="w-[127px] h-[178px] absolute left-2 top-0"
                />
                <div className="w-6 h-[10px] bg-white absolute left-[62px] top-[173px]"></div>
                <div className="w-6 h-[22px] bg-white absolute left-[113px] top-[77px]"></div>
                <div className="w-6 h-[18px] bg-white absolute left-0 top-[73px]"></div>
                <img 
              ...
              <img 
                ...
                alt="Stock4U Logo" 
                className="w-[124px] h-[173px] absolute left-[9px] top-0"
              />
            </div>
          </div>
        </div>
