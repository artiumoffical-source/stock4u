...
export default function EmailEditor() {
  return (
    <div className="w-full bg-white" style={{ width: '800px', height: '800px' }} dir="rtl">
      ...
      <div className="relative" style={{ width: '800px', height: '800px', background: '#FFF' }}>
        ...
        <div className="absolute" style={{ width: '800px', height: '327px', background: '#FFC547', left: '0px', top: '42px' }}>
          ...
          <img 
            ...
            style={{
              ...
              filter: 'drop-shadow(5.4px 5.4px 0 rgba(0, 0, 0, 0.10))',
              left: '599px',
              top: '24px'
            }}
            alt="Group 108307"
          ...
          <img 
            ...
            style={{
              ...
              filter: 'drop-shadow(4.6px 4.6px 0 rgba(0, 0, 0, 0.10))',
              left: '41px',
              top: '22px'
            }}
            alt="Group 108295"
          ...
          <img 
            ...
            style={{
              ...
              filter: 'drop-shadow(5.0px 5.0px 0 rgba(0, 0, 0, 0.10))',
              left: '691px',
              top: '111px'
            }}
            alt="Group 108292"
          ...
          <svg 
            ...
            style={{
              ...
              strokeWidth: '4px',
              stroke: '#FFF',
              filter: 'drop-shadow(4.2px 4.2px 0 rgba(0, 0, 0, 0.10))',
              left: '683px',
              top: '46px'
            }}
            viewBox="0 0 112 127"
        ...
        <div 
          ...
          style={{
            ...
            borderRadius: '14.4px',
            background: '#FFF',
            boxShadow: '0 1.7px 16.3px 0 rgba(0, 0, 0, 0.25)',
            left: '153px',
            top: '262px'
          }}
        >
          <div className="flex flex-col items-center gap-6" style={{ width: '452px' }}>
            
            {/* Main headings exactly matching Figma */}
            <div className="flex flex-col items-center" style={{ gap: '5.6px' }}>
              <div 
                style={{ 
                  width: '195px',
                  color: '#E96036',
            ...
            <div style={{ width: '113px', height: '29px' }}>
              <div 
                ...
                style={{
                  ...
                  borderRadius: '23.4px',
                  background: '#4C7EFB',
                  boxShadow: '4.2px 4.2px 0 0 rgba(0, 0, 0, 0.10)'
                }}
              >
                <div 
                  style={{
