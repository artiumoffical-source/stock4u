...
export default function StockSelection() {
  ...
  const individualStocks = [
    ...
    },
    {
      ...
      description:
        "אמזון היא ענקית המסחר האלקטרוני והענן החישובי בעולם. החברה מפעילה את פלטפור��ת הקניות הגדולה ביותר, שירותי AWS לענן החישובי, ושירותי סטרימינג ובידור דרך Amazon Prime.",
    },
  ];
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <div className="px-6 py-12">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div
            className={`grid gap-6 mb-12 ${selectedTab === "individual" ? "grid-cols-3" : "grid-cols-2 max-w-[900px] mx-auto"}`}
          >
